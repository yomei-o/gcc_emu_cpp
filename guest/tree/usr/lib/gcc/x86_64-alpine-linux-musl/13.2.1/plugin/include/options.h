...
enum opt_code
{
  ...
  OPT_mamx_bf16 = 1912,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1913,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1914,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1915,                      /* -mamx-int8 */
  OPT_mamx_tile = 1916,                      /* -mamx-tile */
  OPT_mandroid = 1917,                       /* -mandroid */
  ...
  OPT_mbionic = 1946,                        /* -mbionic */
  OPT_mbmi = 1947,                           /* -mbmi */
  OPT_mbmi2 = 1948,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1949,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1950,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1951,                    /* -mcet-switch */
  OPT_mcld = 1952,                           /* -mcld */
  OPT_mcldemote = 1953,                      /* -mcldemote */
  OPT_mclflushopt = 1954,                    /* -mclflushopt */
  OPT_mclwb = 1955,                          /* -mclwb */
  OPT_mclzero = 1956,                        /* -mclzero */
  OPT_mcmodel_ = 1957,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1958,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 1959, */                    /* -mcpu= */
  OPT_mcrc32 = 1960,                         /* -mcrc32 */
  OPT_mcx16 = 1961,                          /* -mcx16 */
  OPT_mdaz_ftz = 1962,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1963,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1964,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1965,            /* -mdump-tune-features */
  OPT_menqcmd = 1966,                        /* -menqcmd */
  OPT_mf16c = 1967,                          /* -mf16c */
  OPT_mfancy_math_387 = 1968,                /* -mfancy-math-387 */
  OPT_mfentry = 1969,                        /* -mfentry */
  OPT_mfentry_name_ = 1970,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1971,               /* -mfentry-section= */
  OPT_mfma = 1972,                           /* -mfma */
  OPT_mfma4 = 1973,                          /* -mfma4 */
  OPT_mforce_drap = 1974,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1975,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1976,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1977,                       /* -mfpmath= */
  OPT_mfsgsbase = 1978,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1979,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1980, */              /* -mfused-madd */
  OPT_mfxsr = 1981,                          /* -mfxsr */
  /* OPT_mgather = 1982, */                  /* -mgather */
  OPT_mgeneral_regs_only = 1983,             /* -mgeneral-regs-only */
  OPT_mgfni = 1984,                          /* -mgfni */
  OPT_mglibc = 1985,                         /* -mglibc */
  ...
  OPT_mmusl = 2019,                          /* -mmusl */
  OPT_mmwait = 2020,                         /* -mmwait */
  OPT_mmwaitx = 2021,                        /* -mmwaitx */
  OPT_mneeded = 2022,                        /* -mneeded */
  OPT_mno_align_stringops = 2023,            /* -mno-align-stringops */
  ...
  OPT_mnop_mcount = 2029,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2030,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2031,                          /* -mpc32 */
  OPT_mpc64 = 2032,                          /* -mpc64 */
  OPT_mpc80 = 2033,                          /* -mpc80 */
  OPT_mpclmul = 2034,                        /* -mpclmul */
  OPT_mpcommit = 2035,                       /* -mpcommit */
  OPT_mpconfig = 2036,                       /* -mpconfig */
  OPT_mpku = 2037,                           /* -mpku */
  OPT_mpopcnt = 2038,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2039, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2040,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2041,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2042,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2043,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2044,                        /* -mprfchw */
  OPT_mptwrite = 2045,                       /* -mptwrite */
  OPT_mpush_args = 2046,                     /* -mpush-args */
  OPT_mraoint = 2047,                        /* -mraoint */
  OPT_mrdpid = 2048,                         /* -mrdpid */
  OPT_mrdrnd = 2049,                         /* -mrdrnd */
  OPT_mrdseed = 2050,                        /* -mrdseed */
  OPT_mrecip = 2051,                         /* -mrecip */
  OPT_mrecip_ = 2052,                        /* -mrecip= */
  OPT_mrecord_mcount = 2053,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2054,                 /* -mrecord-return */
  OPT_mred_zone = 2055,                      /* -mred-zone */
  OPT_mregparm_ = 2056,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2057,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2058,                           /* -mrtd */
  OPT_mrtm = 2059,                           /* -mrtm */
  OPT_msahf = 2060,                          /* -msahf */
  /* OPT_mscatter = 2061, */                 /* -mscatter */
  OPT_mserialize = 2062,                     /* -mserialize */
  OPT_msgx = 2063,                           /* -msgx */
  OPT_msha = 2064,                           /* -msha */
  OPT_mshstk = 2065,                         /* -mshstk */
  OPT_mskip_rax_setup = 2066,                /* -mskip-rax-setup */
  OPT_msoft_float = 2067,                    /* -msoft-float */
  OPT_msse = 2068,                           /* -msse */
  OPT_msse2 = 2069,                          /* -msse2 */
  OPT_msse2avx = 2070,                       /* -msse2avx */
  OPT_msse3 = 2071,                          /* -msse3 */
  OPT_msse4 = 2072,                          /* -msse4 */
  OPT_msse4_1 = 2073,                        /* -msse4.1 */
  OPT_msse4_2 = 2074,                        /* -msse4.2 */
  OPT_msse4a = 2075,                         /* -msse4a */
  /* OPT_msse5 = 2076, */                    /* -msse5 */
  OPT_msseregparm = 2077,                    /* -msseregparm */
  OPT_mssse3 = 2078,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2079,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2080, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2081,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2082, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2083,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2084,                  /* -mstackrealign */
  OPT_mstore_max_ = 2085,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2086,            /* -mstringop-strategy= */
  OPT_mstv = 2087,                           /* -mstv */
  OPT_mtbm = 2088,                           /* -mtbm */
  OPT_mtls_dialect_ = 2089,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2090,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2091,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2092,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2093,                         /* -mtune= */
  OPT_muclibc = 2094,                        /* -muclibc */
  OPT_muintr = 2095,                         /* -muintr */
  OPT_munroll_only_small_loops = 2096,       /* -munroll-only-small-loops */
  OPT_mvaes = 2097,                          /* -mvaes */
  OPT_mveclibabi_ = 2098,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2099,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2100,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2101,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2102,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2103,                      /* -mwbnoinvd */
  OPT_mwidekl = 2104,                        /* -mwidekl */
  OPT_mx32 = 2105,                           /* -mx32 */
  OPT_mxop = 2106,                           /* -mxop */
  OPT_mxsave = 2107,                         /* -mxsave */
  OPT_mxsavec = 2108,                        /* -mxsavec */
  OPT_mxsaveopt = 2109,                      /* -mxsaveopt */
  OPT_mxsaves = 2110,                        /* -mxsaves */
  OPT_n = 2111,                              /* -n */
  OPT_name_sort = 2112,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2113,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2114,              /* -no-integrated-cpp */
  OPT_no_pie = 2115,                         /* -no-pie */
  OPT_nocpp = 2116,                          /* -nocpp */
  OPT_nodefaultlibs = 2117,                  /* -nodefaultlibs */
  OPT_nolibc = 2118,                         /* -nolibc */
  OPT_nophoboslib = 2119,                    /* -nophoboslib */
  OPT_nostartfiles = 2120,                   /* -nostartfiles */
  OPT_nostdinc = 2121,                       /* -nostdinc */
  OPT_nostdinc__ = 2122,                     /* -nostdinc++ */
  OPT_nostdlib = 2123,                       /* -nostdlib */
  OPT_nostdlib__ = 2124,                     /* -nostdlib++ */
  OPT_o = 2125,                              /* -o */
  OPT_objects = 2126,                        /* -objects */
  OPT_p = 2127,                              /* -p */
  OPT_pass_exit_codes = 2128,                /* -pass-exit-codes */
  /* OPT_pedantic = 2129, */                 /* -pedantic */
  OPT_pedantic_errors = 2130,                /* -pedantic-errors */
  OPT_pg = 2131,                             /* -pg */
  OPT_pie = 2132,                            /* -pie */
  OPT_pipe = 2133,                           /* -pipe */
  OPT_posix = 2134,                          /* -posix */
  OPT_print_file_name_ = 2135,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2136,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2137,          /* -print-multi-directory */
  OPT_print_multi_lib = 2138,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2139,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2140,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2141,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2142,               /* -print-prog-name= */
  OPT_print_search_dirs = 2143,              /* -print-search-dirs */
  OPT_print_sysroot = 2144,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2145,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2146,                    /* -print-value */
  OPT_profile = 2147,                        /* -profile */
  OPT_pthread = 2148,                        /* -pthread */
  OPT_quiet = 2149,                          /* -quiet */
  OPT_r = 2150,                              /* -r */
  OPT_rdynamic = 2151,                       /* -rdynamic */
  ...
  OPT_time = 2239,                           /* -time */
  OPT_time_ = 2240,                          /* -time= */
  OPT_tno_android_cc = 2241,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2242,                 /* -tno-android-ld */
  OPT_traditional = 2243,                    /* -traditional */
  OPT_traditional_cpp = 2244,                /* -traditional-cpp */
  OPT_tree_stats = 2245,                     /* -tree-stats */
  OPT_trigraphs = 2246,                      /* -trigraphs */
  OPT_type_stats = 2247,                     /* -type-stats */
  OPT_u = 2248,                              /* -u */
  OPT_undef = 2249,                          /* -undef */
  OPT_v = 2250,                              /* -v */
  OPT_version = 2251,                        /* -version */
  OPT_w = 2252,                              /* -w */
  OPT_wrapper = 2253,                        /* -wrapper */
  OPT_x = 2254,                              /* -x */
  OPT_z = 2255,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
