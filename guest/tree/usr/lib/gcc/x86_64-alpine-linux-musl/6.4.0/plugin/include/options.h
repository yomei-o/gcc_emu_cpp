...
enum opt_code
{
  ...
  OPT_mfunction_return_ = 1242,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1243, */              /* -mfused-madd */
  OPT_mfxsr = 1244,                          /* -mfxsr */
  OPT_mglibc = 1245,                         /* -mglibc */
  OPT_mhard_float = 1246,                    /* -mhard-float */
  OPT_mhle = 1247,                           /* -mhle */
  OPT_miamcu = 1248,                         /* -miamcu */
  OPT_mieee_fp = 1249,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1250,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1251,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1252,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1253,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1254,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1255, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1256,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1257,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1258,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1259,                /* -mlong-double-80 */
  OPT_mlwp = 1260,                           /* -mlwp */
  OPT_mlzcnt = 1261,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1262,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1263,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1264,                  /* -mmitigate-rop */
  OPT_mmmx = 1265,                           /* -mmmx */
  OPT_mmovbe = 1266,                         /* -mmovbe */
  OPT_mmpx = 1267,                           /* -mmpx */
  OPT_mms_bitfields = 1268,                  /* -mms-bitfields */
  OPT_mmusl = 1269,                          /* -mmusl */
  OPT_mmwaitx = 1270,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1271,            /* -mno-align-stringops */
  OPT_mno_default = 1272,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1273,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1274,                  /* -mno-push-args */
  OPT_mno_red_zone = 1275,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1276,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1277,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1278,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1279,                          /* -mpc32 */
  OPT_mpc64 = 1280,                          /* -mpc64 */
  OPT_mpc80 = 1281,                          /* -mpc80 */
  OPT_mpclmul = 1282,                        /* -mpclmul */
  OPT_mpcommit = 1283,                       /* -mpcommit */
  OPT_mpku = 1284,                           /* -mpku */
  OPT_mpopcnt = 1285,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1286,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1287,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1288,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1289,                        /* -mprfchw */
  OPT_mpush_args = 1290,                     /* -mpush-args */
  OPT_mrdrnd = 1291,                         /* -mrdrnd */
  OPT_mrdseed = 1292,                        /* -mrdseed */
  OPT_mrecip = 1293,                         /* -mrecip */
  OPT_mrecip_ = 1294,                        /* -mrecip= */
  OPT_mrecord_mcount = 1295,                 /* -mrecord-mcount */
  OPT_mred_zone = 1296,                      /* -mred-zone */
  OPT_mregparm_ = 1297,                      /* -mregparm= */
  OPT_mrtd = 1298,                           /* -mrtd */
  OPT_mrtm = 1299,                           /* -mrtm */
  OPT_msahf = 1300,                          /* -msahf */
  OPT_msha = 1301,                           /* -msha */
  OPT_mskip_rax_setup = 1302,                /* -mskip-rax-setup */
  OPT_msoft_float = 1303,                    /* -msoft-float */
  OPT_msse = 1304,                           /* -msse */
  OPT_msse2 = 1305,                          /* -msse2 */
  OPT_msse2avx = 1306,                       /* -msse2avx */
  OPT_msse3 = 1307,                          /* -msse3 */
  OPT_msse4 = 1308,                          /* -msse4 */
  OPT_msse4_1 = 1309,                        /* -msse4.1 */
  OPT_msse4_2 = 1310,                        /* -msse4.2 */
  OPT_msse4a = 1311,                         /* -msse4a */
  /* OPT_msse5 = 1312, */                    /* -msse5 */
  OPT_msseregparm = 1313,                    /* -msseregparm */
  OPT_mssse3 = 1314,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1315,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1316,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1317,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1318,            /* -mstringop-strategy= */
  OPT_mstv = 1319,                           /* -mstv */
  OPT_mtbm = 1320,                           /* -mtbm */
  OPT_mtls_dialect_ = 1321,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1322,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1323,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1324,                         /* -mtune= */
  OPT_muclibc = 1325,                        /* -muclibc */
  OPT_mveclibabi_ = 1326,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1327,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1328,                    /* -mvzeroupper */
  OPT_mx32 = 1329,                           /* -mx32 */
  OPT_mxop = 1330,                           /* -mxop */
  OPT_mxsave = 1331,                         /* -mxsave */
  OPT_mxsavec = 1332,                        /* -mxsavec */
  OPT_mxsaveopt = 1333,                      /* -mxsaveopt */
  OPT_mxsaves = 1334,                        /* -mxsaves */
  OPT_n = 1335,                              /* -n */
  OPT_no_canonical_prefixes = 1336,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1337,              /* -no-integrated-cpp */
  OPT_no_pie = 1338,                         /* -no-pie */
  OPT_nocpp = 1339,                          /* -nocpp */
  OPT_nodefaultlibs = 1340,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1341,                   /* -nostartfiles */
  OPT_nostdinc = 1342,                       /* -nostdinc */
  OPT_nostdinc__ = 1343,                     /* -nostdinc++ */
  OPT_nostdlib = 1344,                       /* -nostdlib */
  OPT_o = 1345,                              /* -o */
  OPT_p = 1346,                              /* -p */
  OPT_pass_exit_codes = 1347,                /* -pass-exit-codes */
  /* OPT_pedantic = 1348, */                 /* -pedantic */
  OPT_pedantic_errors = 1349,                /* -pedantic-errors */
  OPT_pg = 1350,                             /* -pg */
  OPT_pie = 1351,                            /* -pie */
  OPT_pipe = 1352,                           /* -pipe */
  OPT_posix = 1353,                          /* -posix */
  OPT_print_file_name_ = 1354,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1355,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1356,          /* -print-multi-directory */
  OPT_print_multi_lib = 1357,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1358,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1359,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1360,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1361,               /* -print-prog-name= */
  OPT_print_search_dirs = 1362,              /* -print-search-dirs */
  OPT_print_sysroot = 1363,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1364,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1365,                        /* -profile */
  OPT_pthread = 1366,                        /* -pthread */
  OPT_quiet = 1367,                          /* -quiet */
  OPT_r = 1368,                              /* -r */
  OPT_rdynamic = 1369,                       /* -rdynamic */
  OPT_remap = 1370,                          /* -remap */
  OPT_s = 1371,                              /* -s */
  OPT_s_bc_abi = 1372,                       /* -s-bc-abi */
  OPT_save_temps = 1373,                     /* -save-temps */
  OPT_save_temps_ = 1374,                    /* -save-temps= */
  OPT_shared = 1375,                         /* -shared */
  OPT_shared_libgcc = 1376,                  /* -shared-libgcc */
  /* OPT_specs = 1377, */                    /* -specs */
  OPT_specs_ = 1378,                         /* -specs= */
  OPT_static = 1379,                         /* -static */
  OPT_static_libasan = 1380,                 /* -static-libasan */
  OPT_static_libgcc = 1381,                  /* -static-libgcc */
  OPT_static_libgcj = 1382,                  /* -static-libgcj */
  OPT_static_libgfortran = 1383,             /* -static-libgfortran */
  OPT_static_libgo = 1384,                   /* -static-libgo */
  OPT_static_liblsan = 1385,                 /* -static-liblsan */
  OPT_static_libmpx = 1386,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1387,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1388,               /* -static-libstdc++ */
  OPT_static_libtsan = 1389,                 /* -static-libtsan */
  OPT_static_libubsan = 1390,                /* -static-libubsan */
  /* OPT_std_c__03 = 1391, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1392, */                /* -std=c++0x */
  OPT_std_c__11 = 1393,                      /* -std=c++11 */
  OPT_std_c__14 = 1394,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1395, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1396, */                /* -std=c++1y */
  OPT_std_c__1z = 1397,                      /* -std=c++1z */
  OPT_std_c__98 = 1398,                      /* -std=c++98 */
  OPT_std_c11 = 1399,                        /* -std=c11 */
  /* OPT_std_c1x = 1400, */                  /* -std=c1x */
  /* OPT_std_c89 = 1401, */                  /* -std=c89 */
  OPT_std_c90 = 1402,                        /* -std=c90 */
  OPT_std_c99 = 1403,                        /* -std=c99 */
  /* OPT_std_c9x = 1404, */                  /* -std=c9x */
  OPT_std_f2003 = 1405,                      /* -std=f2003 */
  OPT_std_f2008 = 1406,                      /* -std=f2008 */
  OPT_std_f2008ts = 1407,                    /* -std=f2008ts */
  ...
  OPT_std_gnu__98 = 1417,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1418,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1419, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1420, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1421,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1422,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1423, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1424, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1425,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1426, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1427, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1428, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1429,                     /* -std=legacy */
  OPT_symbolic = 1430,                       /* -symbolic */
  OPT_t = 1431,                              /* -t */
  OPT_time = 1432,                           /* -time */
  OPT_time_ = 1433,                          /* -time= */
  OPT_tno_android_cc = 1434,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1435,                 /* -tno-android-ld */
