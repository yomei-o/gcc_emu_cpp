// MNIST in C, because C++ costs a minute to compile and C costs five seconds.
//
// The same network as the C++ version - 784 in, a hidden layer, 10 out, ReLU and
// softmax, trained by plain stochastic gradient descent - written the way C makes
// you write it: fixed-size arrays, one file, no templates to instantiate.
//
// It is not a worse lesson for that.  The matrix multiply is three nested loops
// either way, and here you can see all of it at once.

export const MNIST_C = {
    title: 'MNIST を C で',
    note: 'C++ 版と同じネットワークを C で。コンパイルが十数倍速いので、こちらから試すのがおすすめです。',
    csv: 'training.csv',
    data: [
...
#endif
`,
        'main.c': `/* MNIST: 手書き数字を学習して当てる。C だけで。
 *
